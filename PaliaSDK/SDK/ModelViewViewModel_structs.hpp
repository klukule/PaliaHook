...
public:
	...
	uint8                                        Pad_116[0x1];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_119[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class UFunction*>                     LoadedFunctions;                                   // 0x10(0x10)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                        Pad_11B[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_120[0x2];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
