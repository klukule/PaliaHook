...
class UClass* UBPFL_MiscUtils_C::StaticClass()
{
...
// BPFL_MiscUtils_C BPFL_MiscUtils.Default__BPFL_MiscUtils_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBPFL_MiscUtils_C* UBPFL_MiscUtils_C::GetDefaultObj()
{
	static class UBPFL_MiscUtils_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBPFL_MiscUtils_C*>(UBPFL_MiscUtils_C::StaticClass()->DefaultObject);
