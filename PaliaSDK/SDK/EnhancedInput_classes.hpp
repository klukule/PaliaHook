...
{
public:
	uint8                                        Pad_B22[0x1A8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_B29[0x50];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_B2A[0xA0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_B2D[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_B7F[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_B83[0x30];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_BB8[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
