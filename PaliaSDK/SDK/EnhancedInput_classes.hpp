...
{
public:
	uint8                                        Pad_B2C[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_C8A[0x1A8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_C91[0x50];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_C94[0xA0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_D0D[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_D0F[0x30];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_D54[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
