...
{
public:
	uint8                                        Pad_876[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_A03[0x1A8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_A09[0x50];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A0A[0xA0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A0B[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_AB7[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_ABE[0x30];                                     // Fixing Size Of Struct [ Dumper-7 ]
