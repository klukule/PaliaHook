...
class UClass* UBPFL_UiHelpers_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BPFL_UiHelpers_C");

	return Clss;
}


// BPFL_UiHelpers_C BPFL_UiHelpers.Default__BPFL_UiHelpers_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBPFL_UiHelpers_C* UBPFL_UiHelpers_C::GetDefaultObj()
{
	static class UBPFL_UiHelpers_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBPFL_UiHelpers_C*>(UBPFL_UiHelpers_C::StaticClass()->DefaultObject);
...
// struct FVitalConfig                CallFunc_FindVitalConfigByType_ReturnValue                       (None)
