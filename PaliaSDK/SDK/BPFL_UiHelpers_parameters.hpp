...
public:
	...
	struct FConfigsManager                       CallFunc_GetConfigsManager_ConfigsManager;         // 0xD8(0xC88)(None)
	...
	struct FWorldMapConfig                       CallFunc_Array_Get_Item;                           // 0xD68(0x88)(None)
	int32                                        CallFunc_Array_Length_ReturnValue;                 // 0xDF0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_Less_IntInt_ReturnValue;                  // 0xDF4(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsWithinMap_InsideOf;                     // 0xDF5(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_Contains_ReturnValue;                     // 0xDF6(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	class UObject*                               __WorldContext;                                    // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FConfigsManager                       ConfigsManager;                                    // 0x8(0xC88)(Parm, OutParm)
	bool                                         IsValid;                                           // 0xC90(0x1)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2EAD[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FConfigsManager                       CallFunc_GetConfigsManagerForBP_ConfigsManager;    // 0xC98(0xC88)(None)
	bool                                         CallFunc_GetConfigsManagerForBP_ReturnValue;       // 0x1920(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	uint8                                        Pad_2F62[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2FC2[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
