...
public:
	...
	uint8                                        Pad_AD6[0x1AB];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_AD7[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_AE9[0x5];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_B12[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	float                                        ChannelDepth;                                      // 0x14(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        CurveRampWidth;                                    // 0x18(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_B1A[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
