...
public:
	...
	uint8                                        Pad_BA7[0x1AB];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_BA8[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_BCE[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
