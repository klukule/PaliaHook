...
public:
	...
	uint8                                        Pad_808[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_80D[0xC0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_815[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_816[0x118];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_81A[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_833[0x2];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_834[0x68];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_837[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
