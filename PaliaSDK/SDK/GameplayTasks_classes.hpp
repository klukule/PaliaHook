...
{
public:
	uint8                                        Pad_C4[0x8];                                       // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_C5[0x2];                                       // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_C6[0x25];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_DA[0x14];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_DC[0x10];                                      // Fixing Size After Last Property  [ Dumper-7 ]
