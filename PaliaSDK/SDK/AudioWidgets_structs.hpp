...
public:
	...
	uint8                                        Pad_1BC6[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1BD1[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1BD2[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
