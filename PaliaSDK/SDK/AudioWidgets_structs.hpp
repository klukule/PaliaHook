...
{
public:
	uint8                                        Pad_1DF2[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1DF3[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1DF9[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
