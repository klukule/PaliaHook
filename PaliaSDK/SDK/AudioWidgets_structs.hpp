...
public:
	...
	uint8                                        Pad_1B4C[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1B4E[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1B50[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
