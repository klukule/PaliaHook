...
public:
	...
	uint8                                        Pad_1E38[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1E3A[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1E3C[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1E41[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
