...
public:
	...
	uint8                                        Pad_1D36[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1D3B[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1D44[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1D60[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1D62[0x44];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1D63[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
