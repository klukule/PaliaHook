...
public:
	...
	uint8                                        Pad_1C24[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1C38[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1C39[0x44];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1C3A[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
