...
{
public:
	uint8                                        Pad_1AA8[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1ACD[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1ADD[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1AE2[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1AE7[0x17];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1BA9[0x28];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1BAA[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
