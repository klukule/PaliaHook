...
class UClass* UGA_Cooking_Minigame_Base_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Cooking_Minigame_Base_C");

	return Clss;
}


// GA_Cooking_Minigame_Base_C GA_Cooking_Minigame_Base.Default__GA_Cooking_Minigame_Base_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Cooking_Minigame_Base_C* UGA_Cooking_Minigame_Base_C::GetDefaultObj()
{
	static class UGA_Cooking_Minigame_Base_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Cooking_Minigame_Base_C*>(UGA_Cooking_Minigame_Base_C::StaticClass()->DefaultObject);
