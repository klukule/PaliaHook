...
public:
	...
	struct FVillagerConfig                       CallFunc_GetVillagerDataTableRow_ReturnValue;      // 0x170(0x148)(None)
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData;              // 0x2B8(0x50)(HasGetValueTypeHash)
	bool                                         K2Node_SwitchEnum_CmpSuccess;                      // 0x308(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_4D95[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array;                            // 0x310(0x10)(ReferenceParm)
	class FText                                  CallFunc_Format_ReturnValue;                       // 0x320(0x18)(None)
	class FText                                  K2Node_Select_Default;                             // 0x338(0x18)(None)
};
...
public:
	...
	uint8                                        Pad_4D98[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4DA0[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
