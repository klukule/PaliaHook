...
public:
	...
	uint8                                        Pad_19E2[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_19EC[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1A23[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1A28[0x4C];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1A2B[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1A35[0x2C];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1A3F[0x24];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1A43[0x68];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1A44[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1A4D[0xC8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1A53[0xC8];                                    // Fixing Size Of Struct [ Dumper-7 ]
