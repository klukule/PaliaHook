...
{
public:
	uint8                                        Pad_16B7[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_16CD[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
