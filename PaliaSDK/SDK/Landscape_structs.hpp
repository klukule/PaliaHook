...
{
public:
	uint8                                        Pad_D5D[0x1];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_D87[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_D9D[0x1];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_DB9[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_DCB[0x1];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
