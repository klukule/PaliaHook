...
class UClass* UGA_Cooking_OneOff_CollectAnim_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Cooking_OneOff_CollectAnim_C");

	return Clss;
}


// GA_Cooking_OneOff_CollectAnim_C GA_Cooking_OneOff_CollectAnim.Default__GA_Cooking_OneOff_CollectAnim_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Cooking_OneOff_CollectAnim_C* UGA_Cooking_OneOff_CollectAnim_C::GetDefaultObj()
{
	static class UGA_Cooking_OneOff_CollectAnim_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Cooking_OneOff_CollectAnim_C*>(UGA_Cooking_OneOff_CollectAnim_C::StaticClass()->DefaultObject);
