...
{
public:
	uint8                                        Pad_8C9[0xC0];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_8CA[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_8CB[0x9];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_8CC[0xC8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
