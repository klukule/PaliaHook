...
{
public:
	uint8                                        Pad_1859[0xC0];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_185A[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_185B[0x9];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_185C[0xC8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
