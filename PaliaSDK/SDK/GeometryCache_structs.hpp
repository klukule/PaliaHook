...
{
public:
	uint8                                        Pad_973[0xC0];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_974[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_976[0x9];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_978[0xC8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
