...
public:
	...
	uint8                                        Pad_1AD8[0x1C];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1AF1[0x178];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1B1A[0x768];                                   // Fixing Size Of Struct [ Dumper-7 ]
