...
public:
	...
	uint8                                        Pad_1B6E[0x1C];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1B90[0x178];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1BB3[0x768];                                   // Fixing Size Of Struct [ Dumper-7 ]
