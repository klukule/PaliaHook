...
public:
	...
	uint8                                        Pad_1AB9[0x1C];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1AF8[0x178];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1B2A[0x768];                                   // Fixing Size Of Struct [ Dumper-7 ]
