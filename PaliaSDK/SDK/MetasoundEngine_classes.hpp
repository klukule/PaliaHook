...
public:
	...
	uint8                                        Pad_10[0x4];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_14[0x68];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_20[0x198];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_24[0x68];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_28[0xC];                                       // Fixing Size Of Struct [ Dumper-7 ]
