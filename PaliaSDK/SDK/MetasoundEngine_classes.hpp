...
public:
	...
	uint8                                        Pad_6[0x4];                                        // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_B[0x68];                                       // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1D[0x198];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_20[0x68];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_23[0xC];                                       // Fixing Size Of Struct [ Dumper-7 ]
