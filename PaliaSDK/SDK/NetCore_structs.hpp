...
{
public:
	uint8                                        Pad_256E[0x54];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2571[0xA8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_258C[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_25B0[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
