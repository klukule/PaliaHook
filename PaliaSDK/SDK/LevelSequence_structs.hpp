...
{
public:
	uint8                                        Pad_10D3[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_10D7[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_10D9[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_10EC[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
