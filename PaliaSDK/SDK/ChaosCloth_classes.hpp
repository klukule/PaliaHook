...
public:
	...
	uint8                                        Pad_1B09[0x5];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1B0E[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1B4E[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1B54[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
