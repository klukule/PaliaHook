...
public:
	...
	uint8                                        Pad_197D[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1982[0x5];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1986[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_19B5[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
	...
	void SetWind(const struct FVector2D& InDrag, const struct FVector2D& InLift, float InAirDensity, const struct FVector& InWindVelocity);
	void SetVelocityScale(const struct FVector& InLinearVelocityScale, float InAngularVelocityScale, float InFictitiousAngularScale);
	void SetPressure(const struct FVector2D& InPressure);
	void SetMaterialLinear(float InEdgeStiffness, float InBendingStiffness, float InAreaStiffness);
	void SetMaterial(const struct FVector2D& InEdgeStiffness, const struct FVector2D& InBendingStiffness, const struct FVector2D& InAreaStiffness);
	void SetLongRangeAttachmentLinear(float InTetherStiffness, float InTetherScale);
	void SetLongRangeAttachment(const struct FVector2D& InTetherStiffness, const struct FVector2D& InTetherScale);
	void SetGravity(float InGravityScale, bool InbIsGravityOverridden, const struct FVector& InGravityOverride);
	void SetDamping(float InDampingCoefficient, float InLocalDampingCoefficient);
	void SetCollision(float InCollisionThickness, float InFrictionCoefficient, bool InbUseCCD, float InSelfCollisionThickness);
	void SetBackstop(bool InbEnabled);
	void SetAnimDriveLinear(float InAnimDriveStiffness);
	void SetAnimDrive(const struct FVector2D& InAnimDriveStiffness, const struct FVector2D& InAnimDriveDamping);
	void SetAerodynamics(float InDragCoefficient, float InLiftCoefficient, const struct FVector& InWindVelocity);
	void ResetAndTeleport(bool InbReset, bool InbTeleport);
};
