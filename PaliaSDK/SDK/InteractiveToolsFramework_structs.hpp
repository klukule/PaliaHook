...
public:
	...
	uint8                                        Pad_10EA[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_10EF[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_10F7[0x128];                                   // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_10FD[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
