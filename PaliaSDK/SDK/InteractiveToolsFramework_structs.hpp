...
{
public:
	uint8                                        Pad_7CD[0x128];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_7CE[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_7CF[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_7D1[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
