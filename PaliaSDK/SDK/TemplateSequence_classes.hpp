...
public:
	...
	uint8                                        Pad_1352[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_135B[0x7C];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_135E[0x260];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_135F[0x60];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1389[0x70];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_138D[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1394[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
