...
public:
	...
	uint8                                        Pad_1506[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_150C[0x7C];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_150F[0x260];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1512[0x60];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_154C[0x70];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1553[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1558[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
