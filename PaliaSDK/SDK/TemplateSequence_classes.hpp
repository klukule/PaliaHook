...
public:
	...
	uint8                                        Pad_2B[0x7C];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2E[0x260];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_31[0x60];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_44[0x70];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_46[0x58];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_47[0x50];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_58[0x4];                                       // Fixing Size Of Struct [ Dumper-7 ]
