...
public:
	...
	uint8                                        Pad_6CA[0x40];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_6CC[0x4B8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_6D2[0x80];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_6D6[0xB8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_6DE[0x80];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_6E0[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_6E6[0x40];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_6ED[0x210];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_6F2[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_6F7[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_707[0x148];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_70A[0x58];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_70D[0xD0];                                     // Fixing Size Of Struct [ Dumper-7 ]
