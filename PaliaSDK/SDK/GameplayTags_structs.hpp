...
{
public:
	uint8                                        Pad_22BC[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_22BE[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_22C1[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_22C8[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
