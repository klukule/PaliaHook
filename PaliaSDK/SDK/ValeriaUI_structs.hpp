...
public:
	...
	TSoftObjectPtr<class UTexture2D>             Icon;                                              // 0x40(0x30)(Edit, BlueprintVisible, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FText                                  ShortName;                                         // 0x70(0x18)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	class FText                                  LongName;                                          // 0x88(0x18)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	class FText                                  MessagePrefix;                                     // 0xA0(0x18)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
...
struct FCrafterUIState
{
public:
	int32                                        SelectedRecipeId;                                  // 0x0(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                        SelectedRecipeListTab;                             // 0x4(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_28C8[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_28CA[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
struct FVALUI_ChatMessageFetchFilter
{
public:
	TSet<enum class EChatMessageType>            Types;                                             // 0x0(0x50)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	int32                                        MessageCount;                                      // 0x50(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	bool                                         bVillagerStoreOpened;                              // 0x4(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bDialogueOpened;                                   // 0x5(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	class FText                                  TaxMessage;                                        // 0x30(0x18)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	class FText                                  DisplayPriceText;                                  // 0x48(0x18)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	class FText                                  DisplayRegularPriceText;                           // 0x60(0x18)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
};
