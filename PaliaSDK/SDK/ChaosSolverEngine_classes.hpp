...
{
public:
	uint8                                        Pad_22F2[0x110];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_22F4[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	struct FHitResult ConvertPhysicsCollisionToHitResult(struct FChaosPhysicsCollisionInfo& InPhysicsCollision);
};
...
public:
	...
	uint8                                        Pad_2317[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2319[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_231B[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
	...
	void SetSolverActive(bool InbActive);
