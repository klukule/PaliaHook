...
{
public:
	uint8                                        Pad_1A48[0x110];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1A4C[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1A6D[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1A6E[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
