...
{
public:
	uint8                                        Pad_1C12[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1C13[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1C14[0x110];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1C15[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1C2A[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
