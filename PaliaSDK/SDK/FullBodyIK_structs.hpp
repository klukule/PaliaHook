...
public:
	...
	uint8                                        Pad_259A[0xA];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_259B[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_25A2[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_25A4[0x198];                                   // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_25AD[0x9];                                     // Fixing Size After Last Property  [ Dumper-7 ]
