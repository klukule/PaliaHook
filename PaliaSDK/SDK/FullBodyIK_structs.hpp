...
public:
	...
	uint8                                        Pad_1B9A[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1BA0[0xA];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1BA1[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1BA2[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1BA9[0x198];                                   // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1BAE[0x9];                                     // Fixing Size After Last Property  [ Dumper-7 ]
