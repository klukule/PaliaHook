...
public:
	...
	uint8                                        Pad_22AC[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_22BA[0xA];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_22BB[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_22C1[0x198];                                   // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_22C4[0x9];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_22C5[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
