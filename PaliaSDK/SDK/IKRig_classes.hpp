...
{
public:
	uint8                                        Pad_14C2[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_15A6[0x148];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_15A7[0x1F8];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_15BB[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_15CF[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_15EC[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_15FD[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
