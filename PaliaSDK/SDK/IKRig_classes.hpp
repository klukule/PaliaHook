...
{
public:
	uint8                                        Pad_174B[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1755[0xD8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_17E5[0x148];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_17E6[0x1F8];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1812[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_184B[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1860[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
