...
public:
	...
	uint8                                        Pad_16F8[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_17AC[0x20];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_17B1[0x38];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_17B4[0xB8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_17B5[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_17DA[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
