...
public:
	...
	uint8                                        Pad_134F[0x70];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1350[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_13A4[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_13D7[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_140F[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1413[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_141B[0x3C];                                    // Fixing Size Of Struct [ Dumper-7 ]
