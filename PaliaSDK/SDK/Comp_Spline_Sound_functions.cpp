...
class UClass* UComp_Spline_Sound_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Comp_Spline_Sound_C");

	return Clss;
}


// Comp_Spline_Sound_C Comp_Spline_Sound.Default__Comp_Spline_Sound_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UComp_Spline_Sound_C* UComp_Spline_Sound_C::GetDefaultObj()
{
	static class UComp_Spline_Sound_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UComp_Spline_Sound_C*>(UComp_Spline_Sound_C::StaticClass()->DefaultObject);
