...
class UClass* UAk_OneShot_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Ak_OneShot_C");

	return Clss;
}


// Ak_OneShot_C Ak_OneShot.Default__Ak_OneShot_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAk_OneShot_C* UAk_OneShot_C::GetDefaultObj()
{
	static class UAk_OneShot_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAk_OneShot_C*>(UAk_OneShot_C::StaticClass()->DefaultObject);
