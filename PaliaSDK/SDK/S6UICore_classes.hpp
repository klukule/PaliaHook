...
{
public:
	uint8                                        Pad_89B[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_8B5[0x78];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_935[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_936[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_945[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_A13[0x70];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A15[0x150];                                    // Fixing Size Of Struct [ Dumper-7 ]
