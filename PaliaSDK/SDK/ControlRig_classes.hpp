...
{
public:
	uint8                                        Pad_1048[0x60];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_104A[0x71];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_104B[0x74];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_104C[0x58];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TMap<struct FRigElementKey, struct FRigElementKey> PreviousNameMap;                                   // 0x1D8(0x50)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_104D[0x80];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_104E[0x70];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_10BA[0x1E];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_10BB[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_10BF[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_10C1[0xA8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FControlRigDrawContainer              DrawContainer;                                     // 0x2B8(0x18)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_10C2[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_10C3[0xD0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_10C5[0xC8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_10C6[0x47];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_10CD[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1147[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_114B[0xB0];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1168[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1173[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1176[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1179[0x2F];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_11F1[0x6C];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_11F4[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_11F6[0x40];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_11F9[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_11FA[0x40];                                    // Fixing Size After Last Property  [ Dumper-7 ]
