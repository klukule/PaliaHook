...
{
public:
	uint8                                        Pad_1176[0x60];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1177[0x71];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1178[0x74];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1179[0x58];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TMap<struct FRigElementKey, struct FRigElementKey> PreviousNameMap;                                   // 0x1D8(0x50)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_117A[0x80];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_117B[0x70];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_122F[0x1E];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1239[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_123C[0xA8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FControlRigDrawContainer              DrawContainer;                                     // 0x2B8(0x18)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_123D[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1240[0xD0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1244[0xC8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1245[0x47];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_12A2[0xB0];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_12B2[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_12B6[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_12B8[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_12B9[0x2F];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_130D[0x6C];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1311[0x40];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1315[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1316[0x40];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1328[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1339[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
