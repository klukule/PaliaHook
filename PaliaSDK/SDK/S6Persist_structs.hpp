...
{
public:
	uint8                                        Pad_1A7C[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1A7D[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1A86[0x20];                                    // Fixing Size After Last Property  [ Dumper-7 ]
