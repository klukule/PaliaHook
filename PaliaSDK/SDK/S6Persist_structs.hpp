...
{
public:
	uint8                                        Pad_1CE8[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1CE9[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1CF3[0x20];                                    // Fixing Size After Last Property  [ Dumper-7 ]
