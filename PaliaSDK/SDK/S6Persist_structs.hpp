...
{
public:
	uint8                                        Pad_20E5[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_20E8[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_20F9[0x20];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_20FC[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
