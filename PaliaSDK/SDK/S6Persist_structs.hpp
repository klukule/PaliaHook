...
{
public:
	uint8                                        Pad_1EBF[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1EDA[0x20];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TSet<struct FS6PersistOperation>             Operations;                                        // 0x20(0x50)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_1EDB[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
