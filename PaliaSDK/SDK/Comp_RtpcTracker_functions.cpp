...
class UClass* UComp_RtpcTracker_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Comp_RtpcTracker_C");

	return Clss;
}


// Comp_RtpcTracker_C Comp_RtpcTracker.Default__Comp_RtpcTracker_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UComp_RtpcTracker_C* UComp_RtpcTracker_C::GetDefaultObj()
{
	static class UComp_RtpcTracker_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UComp_RtpcTracker_C*>(UComp_RtpcTracker_C::StaticClass()->DefaultObject);
...
// TMap<class UAkRtpc*, double>       CallFunc_GetRtpcs_RTPC_Map                                       (None)
...
// TMap<class UAkRtpc*, double>       CallFunc_GetRtpcs_RTPC_Map_1                                     (None)
