...
class UClass* UGA_Gardening_Harvest_C::StaticClass()
{
...
// GA_Gardening_Harvest_C GA_Gardening_Harvest.Default__GA_Gardening_Harvest_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Gardening_Harvest_C* UGA_Gardening_Harvest_C::GetDefaultObj()
{
	static class UGA_Gardening_Harvest_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Gardening_Harvest_C*>(UGA_Gardening_Harvest_C::StaticClass()->DefaultObject);
