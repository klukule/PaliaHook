...
public:
	...
	uint8                                        Pad_BCA[0xF];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_BCB[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_BDC[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_CB8[0xF];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_CC3[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_CF6[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_D24[0x28];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_D25[0x1C];                                     // Fixing Size Of Struct [ Dumper-7 ]
