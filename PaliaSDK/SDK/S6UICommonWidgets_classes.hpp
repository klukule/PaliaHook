...
public:
	...
	uint8                                        Pad_B62[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_BEC[0xF];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_C4C[0x28];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_C4D[0x1C];                                     // Fixing Size Of Struct [ Dumper-7 ]
