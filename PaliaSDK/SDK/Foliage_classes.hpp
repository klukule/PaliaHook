...
public:
	...
	uint8                                        Pad_2397[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        BitPad_180 : 5;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_23DB[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_23E9[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_23EF[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2431[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2433[0xA0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FProceduralFoliageInstance>    InstancesArray;                                    // 0xD0(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_2434[0x90];                                    // Fixing Size Of Struct [ Dumper-7 ]
