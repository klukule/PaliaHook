...
public:
	...
	uint8                                        Pad_22BC[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        BitPad_15E : 5;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        BitPad_161 : 2;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_22DF[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_22F3[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_22F6[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2313[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2317[0xA0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FProceduralFoliageInstance>    InstancesArray;                                    // 0xD0(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_2318[0x90];                                    // Fixing Size Of Struct [ Dumper-7 ]
