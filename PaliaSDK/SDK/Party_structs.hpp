...
{
public:
	uint8                                        Pad_C31[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_C33[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	struct FPartyMemberPlatformData              PlatformData;                                      // 0x20(0x98)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_C35[0x90];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_C44[0x35];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_C45[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_C4A[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
