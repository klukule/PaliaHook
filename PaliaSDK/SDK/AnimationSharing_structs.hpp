...
public:
	...
	uint8                                        Pad_4A0[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4A2[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4A9[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
