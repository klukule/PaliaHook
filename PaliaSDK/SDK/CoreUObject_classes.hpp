...
{
public:
	uint8                                        Pad_6[0x10];                                       // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	...
	uint8                                        Pad_7[0x54];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_8[0x28];                                       // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A[0x118];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_21[0xD0];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_28[0x40];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_44[0x20];                                      // Fixing Size Of Struct [ Dumper-7 ]
