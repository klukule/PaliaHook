...
{
public:
	uint8                                        Pad_2[0x68];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_D[0x20];                                       // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_F[0x80];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_10[0xB8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_14[0xD0];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_19[0x40];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_22[0x28];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_24[0x20];                                      // Fixing Size Of Struct [ Dumper-7 ]
