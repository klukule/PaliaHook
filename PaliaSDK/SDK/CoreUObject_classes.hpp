...
public:
	...
	uint8                                        Pad_6[0x8];                                        // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
inline bool IsValidLowLevel() {
	...
	{
		return GetVFunction<void(*)(const UObject*, class UFunction*, void*)>(this, 0x4C /*0x2AF8D10*/)(this, Function, Parms);
	}
...
{
public:
	uint8                                        Pad_9[0x10];                                       // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A[0x54];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_B[0x28];                                       // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	enum class EClassCastFlags                   CastFlags;                                         // (0xD8[0x08]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_C[0x30];                                       // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	class UObject*                               DefaultObject;                                     // (0x110[0x08]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_D[0x118];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_E[0x48];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_16[0x80];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_18[0xB8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1A[0x10];                                      // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	class TArray<class TPair<class FName, int64>> Names;                                             // (0x40[0x10]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_1B[0x18];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1C[0x1C0];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1D[0xD0];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1F[0xA0];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2D[0x28];                                      // Fixing Size Of Struct [ Dumper-7 ]
