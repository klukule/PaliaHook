...
{
public:
	uint8                                        Pad_BF7[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_C1A[0xB];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_C1C[0x20];                                     // Fixing Size After Last Property  [ Dumper-7 ]
