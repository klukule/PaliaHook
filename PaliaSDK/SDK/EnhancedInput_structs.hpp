...
{
public:
	uint8                                        Pad_B1F[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_B31[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_B33[0xB];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_B37[0x20];                                     // Fixing Size After Last Property  [ Dumper-7 ]
