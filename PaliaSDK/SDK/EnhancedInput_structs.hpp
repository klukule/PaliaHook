...
{
public:
	uint8                                        Pad_C3B[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_C4E[0x7];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_C5D[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_C66[0xB];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_C6C[0x20];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_C86[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
