...
public:
	...
	uint8                                        Pad_79D[0x90];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_7A7[0x50];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_7A8[0x68];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_7AC[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_7C7[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	class UBodySetup*                            CachedBodySetup;                                   // 0x538(0x8)(ZeroConstructor, NoDestructor, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_7EF[0x40];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_8E3[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_903[0x50];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_94B[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_973[0x98];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_977[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_9FA[0x38];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_9FB[0x28];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_9FC[0x30];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_A22[0x27];                                     // Fixing Size Of Struct [ Dumper-7 ]
