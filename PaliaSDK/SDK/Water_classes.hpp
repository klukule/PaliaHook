...
public:
	...
	uint8                                        Pad_AC8[0x90];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_AD4[0x50];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_AD5[0x68];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_AD9[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_AF1[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_BEE[0x50];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_C55[0x98];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_C58[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_C7A[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_CD5[0x38];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_CE0[0x28];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_CE1[0x30];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_D00[0x27];                                     // Fixing Size Of Struct [ Dumper-7 ]
