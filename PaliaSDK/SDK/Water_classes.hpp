...
public:
	...
	uint8                                        Pad_917[0x90];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_925[0x50];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_926[0x68];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_92B[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_951[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	class UBodySetup*                            CachedBodySetup;                                   // 0x538(0x8)(ZeroConstructor, NoDestructor, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_96C[0x40];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_B3E[0x50];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_BBE[0x98];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_BC0[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_C2C[0x38];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_C33[0x28];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_C65[0x27];                                     // Fixing Size Of Struct [ Dumper-7 ]
