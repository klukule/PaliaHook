...
public:
	...
	uint8                                        Pad_2969[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_296B[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	bool                                         CallFunc_CanPlayerChangeLockWith_ReturnValue;      // 0x120(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
