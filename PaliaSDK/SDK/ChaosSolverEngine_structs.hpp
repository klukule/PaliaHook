...
{
public:
	uint8                                        Pad_1998[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_199A[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_199C[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
