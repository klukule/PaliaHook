...
{
public:
	uint8                                        Pad_1C39[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1C3A[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1C3C[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
