...
{
public:
	uint8                                        Pad_2510[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2511[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2515[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
