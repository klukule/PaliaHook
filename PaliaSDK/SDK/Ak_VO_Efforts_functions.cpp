...
class UClass* UAk_VO_Efforts_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Ak_VO_Efforts_C");

	return Clss;
}


// Ak_VO_Efforts_C Ak_VO_Efforts.Default__Ak_VO_Efforts_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAk_VO_Efforts_C* UAk_VO_Efforts_C::GetDefaultObj()
{
	static class UAk_VO_Efforts_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAk_VO_Efforts_C*>(UAk_VO_Efforts_C::StaticClass()->DefaultObject);
