...
{
public:
	uint8                                        Pad_13DA[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_13F7[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1410[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
