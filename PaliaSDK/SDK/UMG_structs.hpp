...
{
public:
	uint8                                        Pad_17ED[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_17F6[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1801[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
