...
{
public:
	uint8                                        Pad_629[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_631[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_633[0x40];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
