...
public:
	...
	uint8                                        Pad_358[0x1C];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_376[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_379[0x1D];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_37A[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_37D[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_388[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_38D[0x270];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneEntitySystemGraph          SystemGraph;                                       // 0x298(0x138)(NativeAccessSpecifierPublic)
	uint8                                        Pad_38E[0x308];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3AF[0x1F8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3B3[0x88];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3B4[0xB0];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3B7[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3B8[0xB0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3BA[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3BB[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3C2[0xB0];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3D7[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3D8[0x70];                                     // Fixing Size Of Struct [ Dumper-7 ]
