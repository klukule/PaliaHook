...
class UClass* UBPFL_StealthMaskHelpers_C::StaticClass()
{
...
// BPFL_StealthMaskHelpers_C BPFL_StealthMaskHelpers.Default__BPFL_StealthMaskHelpers_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBPFL_StealthMaskHelpers_C* UBPFL_StealthMaskHelpers_C::GetDefaultObj()
{
	static class UBPFL_StealthMaskHelpers_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBPFL_StealthMaskHelpers_C*>(UBPFL_StealthMaskHelpers_C::StaticClass()->DefaultObject);
