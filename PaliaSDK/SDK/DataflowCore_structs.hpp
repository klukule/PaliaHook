...
{
public:
	uint8                                        Pad_27A9[0xC8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_27AB[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_27AE[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
