...
{
public:
	uint8                                        Pad_29F4[0xC8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_29F6[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_29FE[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
