...
{
public:
	uint8                                        Pad_26F0[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_26F3[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_26F4[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
