...
class UClass* UGA_LoopableEvent_Base_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_LoopableEvent_Base_C");

	return Clss;
}


// GA_LoopableEvent_Base_C GA_LoopableEvent_Base.Default__GA_LoopableEvent_Base_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_LoopableEvent_Base_C* UGA_LoopableEvent_Base_C::GetDefaultObj()
{
	static class UGA_LoopableEvent_Base_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_LoopableEvent_Base_C*>(UGA_LoopableEvent_Base_C::StaticClass()->DefaultObject);
...
// struct FValeriaItem                CallFunc_GetEquippedItem_ReturnValue                             (None)
...
// struct FVitalsChange               K2Node_MakeStruct_VitalsChange                                   (None)
...
// struct FGameplayEventData          K2Node_CustomEvent_EventData_10                                  (None)
...
// struct FGameplayEventData          K2Node_CustomEvent_EventData_11                                  (None)
...
// struct FGameplayEventData          K2Node_CustomEvent_EventData_12                                  (None)
// struct FGameplayTag                K2Node_CustomEvent_EventTag_13                                   (NoDestructor, HasGetValueTypeHash)
// struct FGameplayEventData          K2Node_CustomEvent_EventData_13                                  (None)
...
// struct FGameplayEventData          K2Node_CustomEvent_EventData_14                                  (None)
