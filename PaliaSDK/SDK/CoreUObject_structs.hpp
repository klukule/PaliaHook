...
public:
	...
	uint8                                        Pad_2B[0x50];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2E[0xD];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_34[0x38];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_72[0xF];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
