...
public:
	...
	uint8                                        Pad_914[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_91E[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_92E[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_939[0x5];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	bool                                         bIsGamepadKey;                                     // 0x8(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bIsLockedCurrentInput;                             // 0x9(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_93D[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FInputKeys>                    ReturnValue;                                       // 0x10(0x10)(Parm, OutParm, ZeroConstructor, ReturnParm, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_93F[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
