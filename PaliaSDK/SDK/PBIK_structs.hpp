...
public:
	...
	uint8                                        Pad_25A4[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_25A5[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_25A9[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_25AC[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
