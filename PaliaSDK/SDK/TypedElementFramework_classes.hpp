...
{
public:
	uint8                                        Pad_2395[0x920];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_23B2[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_23B5[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_23B6[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
