...
public:
	...
	uint8                                        Pad_15BF[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1746[0xE];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1A10[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	enum class EAREye                            Eye;                                               // 0x0(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1A13[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
