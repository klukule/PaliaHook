...
public:
	...
	uint8                                        Pad_43D[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FS6Vivox_AccountId                    VivoxAccountId;                                    // 0xA0(0x48)(Transient, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_43E[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("S6VivoxSubsystem");
		return Clss;
	}
