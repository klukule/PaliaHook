...
public:
	...
	uint8                                        Pad_FA0[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_FA3[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_FB0[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_FC4[0x28];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_FC6[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_FCB[0x17];                                     // Fixing Size Of Struct [ Dumper-7 ]
	...
	void SetGamepadInputType(class FName InInGamepadInputType);
	void SetCurrentInputType(enum class ECommonInputType InNewInputType);
	bool IsUsingPointerInput();
	bool IsInputMethodActive(enum class ECommonInputType InInputMethod);
