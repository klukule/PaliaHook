...
public:
	...
	uint8                                        Pad_2C7[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2CC[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_311[0x28];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_317[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_319[0x17];                                     // Fixing Size Of Struct [ Dumper-7 ]
