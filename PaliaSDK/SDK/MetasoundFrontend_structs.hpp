...
{
public:
	uint8                                        Pad_65[0x1];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_77[0x1];                                       // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_78[0x1];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_7C[0x10];                                      // Fixing Size After Last Property  [ Dumper-7 ]
