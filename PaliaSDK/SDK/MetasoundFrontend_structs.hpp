...
{
public:
	uint8                                        Pad_2881[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_288F[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2890[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2892[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
